...
A full 16-viewpoint tour and the menu screens are regenerated by
...
The sun moves: a full day passes every 20 real minutes. **Escape → Dev Mode**
gives you flight, noclip, a 1–50x speed multiplier, time-of-day and weather
control, and one-click teleports to every tour viewpoint. See
[Docs/DevMode.md](Docs/DevMode.md).
