...
public:
	...
	TSharedPtr<SWidget> OpenSurveyContract();
	bool IsSurveyContractOpen() const { return Page == EUEGT2MenuPage::SurveyContract; }
...
private:
	...
	TSharedRef<SWidget> BuildSurveyContract();
	...
	TWeakPtr<SWidget> SurveyContractInitialFocus;
